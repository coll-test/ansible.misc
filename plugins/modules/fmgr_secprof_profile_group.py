...
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.fortimanager import FortiManagerHandler
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import FMGBaseException
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import FMGRCommon
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import FMGRMethods
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import DEFAULT_RESULT_OBJ
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import FAIL_SOCKET_MSG
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import prepare_dict
from ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.common import scrub_dict
