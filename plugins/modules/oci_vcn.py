...
- ansible.misc.oracle
- ansible.misc.oracle_creatable_resource
- ansible.misc.oracle_wait_options
- ansible.misc.oracle_tags
'''
...
from ansible_collections.ansible.misc.plugins.module_utils.oracle import oci_utils
