...
from ansible_collections.ansible.misc.plugins.module_utils.network.onyx.onyx import BaseOnyxModule
from ansible_collections.ansible.misc.plugins.module_utils.network.onyx.onyx import get_interfaces_config
