...
from ansible_collections.ansible.misc.plugins.module_utils.database import pg_quote_identifier
from ansible_collections.ansible.misc.plugins.module_utils.postgres import postgres_common_argument_spec
