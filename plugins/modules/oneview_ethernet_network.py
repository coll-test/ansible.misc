...
- ansible.misc.oneview
- ansible.misc.oneview.validateetag
'''
...
from ansible_collections.ansible.misc.plugins.module_utils.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
