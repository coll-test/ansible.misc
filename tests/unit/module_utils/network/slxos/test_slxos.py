...
from ansible_collections.ansible.misc.plugins.module_utils.network.slxos import slxos
...
class TestPluginCLIConfSLXOS(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.misc.plugins.module_utils.network.slxos.slxos.Connection')
