...
from ansible_collections.ansible.misc.plugins.module_utils.network.nos import nos
...
class TestPluginCLIConfNOS(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.misc.plugins.module_utils.network.nos.nos.Connection')
