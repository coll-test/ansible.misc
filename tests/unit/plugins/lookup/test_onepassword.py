...
from ansible_collections.ansible.misc.plugins.lookup.onepassword import OnePass, LookupModule
from ansible_collections.ansible.misc.plugins.lookup.onepassword_raw import LookupModule as OnePasswordRawLookup
...
@patch('ansible_collections.ansible.misc.plugins.lookup.onepassword.OnePass', MockOnePass)
...
@patch('ansible_collections.ansible.misc.plugins.lookup.onepassword_raw.OnePass', MockOnePass)
