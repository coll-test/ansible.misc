...
from ansible_collections.ansible.misc.plugins.lookup.lastpass import LookupModule, LPass, LPassException
...
class TestLastpassPlugin(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.lastpass.LPass', new=MockLPass)
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.lastpass.LPass', LoggedOutMockLPass)
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.lastpass.LPass', DisconnectedMockLPass)
