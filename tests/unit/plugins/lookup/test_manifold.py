...
from ansible_collections.ansible.misc.tests.unit.compat.mock import patch, call
from ansible.errors import AnsibleError
from ansible.module_utils.urls import ConnectionError, SSLValidationError
from ansible.module_utils.six.moves.urllib.error import HTTPError, URLError
from ansible.module_utils import six
from ansible_collections.ansible.misc.plugins.lookup.manifold import ManifoldApiClient, LookupModule, ApiError
import json
...
class TestManifoldApiClient(unittest.TestCase):
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.open_url')
...
class TestLookupModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.display')
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.os.getenv')
    @patch('ansible_collections.ansible.misc.plugins.lookup.manifold.ManifoldApiClient')
