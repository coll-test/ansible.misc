...
from ansible_collections.ansible.misc.plugins.modules import gem
...
class TestGem(ModuleTestCase):
    def setUp(self):
        ...
        self.mocker.patch(
            'ansible_collections.ansible.misc.plugins.modules.gem.get_rubygems_path',
    ...
    def patch_installed_versions(self, versions):
        ...
        target = 'ansible_collections.ansible.misc.plugins.modules.gem.get_installed_versions'
    ...
    def patch_rubygems_version(self, version=None):
        target = 'ansible_collections.ansible.misc.plugins.modules.gem.get_rubygems_version'
