...
from ansible_collections.ansible.misc.plugins.modules import maven_artifact
...
def test_find_version_by_spec(mocker, version_by_spec, version_choosed):
    _getContent = mocker.patch('ansible_collections.ansible.misc.plugins.modules.maven_artifact.MavenDownloader._getContent')
