...
from ansible_collections.ansible.misc.plugins.modules import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.nos_facts.run_commands')
