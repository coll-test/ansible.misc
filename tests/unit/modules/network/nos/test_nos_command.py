...
from ansible_collections.ansible.misc.plugins.modules import nos_command
...
class TestNosCommandModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.nos_command.run_commands')
