...
from ansible_collections.ansible.misc.plugins.modules import nos_config
...
class TestNosConfigModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.misc.plugins.modules.nos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.misc.plugins.modules.nos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.nos_config.run_commands')
