...
from ansible_collections.ansible.misc.plugins.modules import slxos_command
...
class TestSlxosCommandModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.slxos_command.run_commands')
