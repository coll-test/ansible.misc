...
from ansible_collections.ansible.misc.plugins.modules import slxos_facts
...
class TestSlxosFactsModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.slxos_facts.run_commands')
