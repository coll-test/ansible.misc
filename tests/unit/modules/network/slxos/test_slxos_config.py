...
from ansible_collections.ansible.misc.plugins.modules import slxos_config
...
class TestSlxosConfigModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.misc.plugins.modules.slxos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.misc.plugins.modules.slxos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.slxos_config.run_commands')
