...
from ansible_collections.ansible.misc.plugins.modules import slxos_l3_interface
...
class TestSlxosL3InterfaceModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.ansible.misc.plugins.modules.slxos_l3_interface.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.ansible.misc.plugins.modules.slxos_l3_interface.load_config'
        )
