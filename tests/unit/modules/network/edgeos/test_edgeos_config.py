...
from ansible_collections.ansible.misc.plugins.modules import edgeos_config
...
class TestEdgeosConfigModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.misc.plugins.modules.edgeos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.misc.plugins.modules.edgeos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.edgeos_config.run_commands')
