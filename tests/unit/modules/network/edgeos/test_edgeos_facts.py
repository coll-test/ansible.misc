...
from ansible_collections.ansible.misc.plugins.modules import edgeos_facts
...
class TestEdgeosFactsModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.edgeos_facts.run_commands')
