...
from ansible_collections.ansible.misc.plugins.modules import edgeos_command
...
class TestEdgeosCommandModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.edgeos_command.run_commands')
