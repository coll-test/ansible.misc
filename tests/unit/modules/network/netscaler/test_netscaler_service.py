...
class TestNetscalerServiceModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_service.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_service.nitro_exception', MockException):
                self.module = netscaler_service
                result = self.failed()
