...
class TestNetscalerLBVServerModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_lb_vserver.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_lb_vserver.nitro_exception', MockException):
                self.module = netscaler_lb_vserver
                result = self.failed()
