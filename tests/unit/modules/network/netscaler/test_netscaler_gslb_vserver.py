...
from ansible_collections.ansible.misc.tests.unit.compat.mock import patch, Mock, MagicMock, call
...
class TestNetscalerGSLBVserverModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from ansible_collections.ansible.misc.plugins.modules import netscaler_gslb_vserver
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_gslb_vserver.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_gslb_vserver.nitro_exception', MockException):
                self.module = netscaler_gslb_vserver
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'ansible_collections.ansible.misc.plugins.modules.netscaler_gslb_vserver',
            get_nitro_client=m,
