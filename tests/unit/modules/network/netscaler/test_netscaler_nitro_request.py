...
from ansible_collections.ansible.misc.tests.unit.compat.mock import patch, Mock, call
...
from ansible_collections.ansible.misc.plugins.modules import netscaler_nitro_request
...
class TestNetscalerNitroRequestModule(TestModule):
    ...
    def test_fail_on_conflicting_authentication_methods(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_nitro_request.AnsibleModule', module_mock):
    ...
    def test_edit_response_data_no_body_success_status(self):
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_nitro_request.AnsibleModule'):
            instance = netscaler_nitro_request.NitroAPICaller()
            r = None
            info = {
                'status': 200,
