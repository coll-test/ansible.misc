...
class TestNetscalerServicegroupModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_servicegroup.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_servicegroup.nitro_exception', MockException):
                self.module = netscaler_servicegroup
                result = self.failed()
