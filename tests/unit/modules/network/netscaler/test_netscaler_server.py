...
class TestNetscalerServerModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from ansible_collections.ansible.misc.plugins.modules import netscaler_server
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_server.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_server.nitro_exception', MockException):
                self.module = netscaler_server
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'ansible_collections.ansible.misc.plugins.modules.netscaler_server',
            get_nitro_client=m,
