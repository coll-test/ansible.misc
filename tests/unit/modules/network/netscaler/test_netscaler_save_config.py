...
class TestNetscalerSaveConfigModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_save_config.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_save_config.nitro_exception', MockException):
