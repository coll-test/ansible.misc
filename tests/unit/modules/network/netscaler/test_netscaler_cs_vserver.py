...
class TestNetscalerCSVserverModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_cs_vserver.get_nitro_client', m):
            with patch('ansible_collections.ansible.misc.plugins.modules.netscaler_cs_vserver.nitro_exception', MockException):
                self.module = netscaler_cs_vserver
                result = self.failed()
