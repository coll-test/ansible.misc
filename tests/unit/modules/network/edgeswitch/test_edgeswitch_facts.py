...
from ansible_collections.ansible.misc.plugins.modules import edgeswitch_facts
...
class TestEdgeswitchFactsModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.edgeswitch_facts.run_commands')
