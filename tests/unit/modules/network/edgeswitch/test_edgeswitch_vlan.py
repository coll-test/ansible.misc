...
from ansible_collections.ansible.misc.plugins.modules import edgeswitch_vlan
from ansible_collections.ansible.misc.plugins.modules.edgeswitch_vlan import parse_vlan_brief, parse_interfaces_switchport
...
class TestEdgeswitchVlanModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.edgeswitch_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.ansible.misc.plugins.modules.edgeswitch_vlan.load_config')
