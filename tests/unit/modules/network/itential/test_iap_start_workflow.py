...
import mock
import unittest
from ansible_collections.ansible.misc.plugins.modules import iap_start_workflow


class TestWorkflowModule(unittest.TestCase):

    @mock.patch('ansible_collections.ansible.misc.plugins.modules.iap_start_workflow.start_workflow')
