...
from ansible_collections.ansible.misc.plugins.modules import routeros_command
...
class TestRouterosCommandModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.routeros_command.run_commands')
