...
from ansible_collections.ansible.misc.plugins.modules import routeros_facts
...
class TestRouterosFactsModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.routeros_facts.run_commands')
