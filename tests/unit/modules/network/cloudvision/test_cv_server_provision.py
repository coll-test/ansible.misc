...
from ansible_collections.ansible.misc.plugins.modules import cv_server_provision
...
class TestCvServerProvision(unittest.TestCase):
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.CvpApiError',
           new_callable=lambda: MockException)
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.server_configurable_configlet')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_in_compliance')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_info')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.connect')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.AnsibleModule')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.CvpApiError',
           new_callable=lambda: MockException)
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.port_configurable')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.server_configurable_configlet')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_in_compliance')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_info')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.connect')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.configlet_action')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.port_configurable')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.server_configurable_configlet')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_in_compliance')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_info')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.wait_for_task_completion')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.configlet_update_task')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.configlet_action')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.port_configurable')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.server_configurable_configlet')
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.switch_in_compliance')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.CvpClient')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.CvpLoginError',
           new_callable=lambda: MockException)
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.CvpClient')
    ...
    @patch('ansible_collections.ansible.misc.plugins.modules.cv_server_provision.config_from_template')
