...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_fwpol_ipv4
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_fwpol_ipv4.Connection')
    return connection_class_mock
