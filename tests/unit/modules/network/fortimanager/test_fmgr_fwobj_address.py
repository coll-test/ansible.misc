...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_fwobj_address
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_fwobj_address.Connection')
    return connection_class_mock
