...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_secprof_appctrl
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_secprof_appctrl.Connection')
    return connection_class_mock
