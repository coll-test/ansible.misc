...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_fwpol_package
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_fwpol_package.Connection')
    return connection_class_mock
