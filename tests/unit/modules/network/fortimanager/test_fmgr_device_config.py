...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_device_config
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_device_config.Connection')
    return connection_class_mock
