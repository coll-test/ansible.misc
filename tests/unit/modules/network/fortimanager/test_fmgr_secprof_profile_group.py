...
try:
    from ansible_collections.ansible.misc.plugins.modules import fmgr_secprof_profile_group
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.fmgr_secprof_profile_group.Connection')
    return connection_class_mock
...
def test_fmgr_firewall_profile_group_modify(fixture_data, mocker):
    mocker.patch('ansible_collections.ansible.misc.plugins.module_utils.network.fortimanager.fortimanager.FortiManagerHandler.process_request',
