...
from ansible_collections.ansible.misc.plugins.modules import parted as parted_module
from ansible_collections.ansible.misc.plugins.modules.parted import parse_partition_info
...
class TestParted(ModuleTestCase):
    ...
    def test_create_label_gpt(self):
        ...
        with patch('ansible_collections.ansible.misc.plugins.modules.parted.get_device_info', return_value=parted_dict2):
