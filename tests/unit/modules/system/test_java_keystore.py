...
from ansible_collections.ansible.misc.tests.unit.modules.utils import ModuleTestCase, set_module_args
...
from ansible_collections.ansible.misc.plugins.modules.java_keystore import create_jks, cert_changed, ArgumentSpec
...
class TestCreateJavaKeystore(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_create_file = patch('ansible_collections.ansible.misc.plugins.modules.java_keystore.create_file',
                                      side_effect=lambda path, content: path)
        self.mock_run_commands = patch('ansible_collections.ansible.misc.plugins.modules.java_keystore.run_commands')
