...
def test_xenserver_guest_powerstate_set_power_state(mocker, fake_ansible_module, XenAPI, xenserver_guest_powerstate, power_state):
    ...
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.get_object_ref', return_value=fake_xenapi_ref('VM'))
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.gather_vm_params', return_value={"power_state": "Someoldstate"})
    mocked_set_vm_power_state = mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.set_vm_power_state',
...
def test_xenserver_guest_powerstate_present(mocker, patch_ansible_module, capfd, XenAPI, xenserver_guest_powerstate):
    ...
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.get_object_ref', return_value=fake_xenapi_ref('VM'))
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.gather_vm_params', return_value={})
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.gather_vm_facts', return_value=fake_vm_facts)
    mocked_set_vm_power_state = mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.set_vm_power_state',
                                             return_value=(True, "somenewstate"))
    mocked_wait_for_vm_ip_address = mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.wait_for_vm_ip_address',
                                                 return_value={})
...
def test_xenserver_guest_powerstate_other(mocker, patch_ansible_module, capfd, XenAPI, xenserver_guest_powerstate):
    ...
    mocked_set_vm_power_state = mocker.patch(
        'ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.set_vm_power_state',
        return_value=(True, "somenewstate"))
    mocked_wait_for_vm_ip_address = mocker.patch(
        'ansible_collections.ansible.misc.plugins.modules.xenserver_guest_powerstate.wait_for_vm_ip_address',
        return_value={})
