...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.ansible.misc.tests.unit.modules.cloud.xenserver.FakeXenAPI')
...
def xenserver_guest_info(XenAPI):
    ...
    from ansible_collections.ansible.misc.plugins.modules import xenserver_guest_info
...
def xenserver_guest_powerstate(XenAPI):
    ...
    from ansible_collections.ansible.misc.plugins.modules import xenserver_guest_powerstate
