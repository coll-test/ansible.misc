...
def test_xenserver_guest_info(mocker, capfd, XenAPI, xenserver_guest_info):
    ...
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_info.get_object_ref', return_value=None)
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_info.gather_vm_params', return_value=None)
    mocker.patch('ansible_collections.ansible.misc.plugins.modules.xenserver_guest_info.gather_vm_facts', return_value=fake_vm_facts)
