...
import pytest
from ansible_collections.ansible.misc.tests.unit.compat import mock
from ansible_collections.ansible.misc.plugins.modules import lxca_nodes
from ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common import setup_conn
from ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common import close_conn


@pytest.fixture(scope='module')
@mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.close_conn', autospec=True)
...
class TestMyModule():
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_nodes.execute_module', autospec=True)
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_nodes.execute_module', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_nodes.AnsibleModule', autospec=True)
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_nodes._nodes_by_uuid',
                autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_nodes.AnsibleModule',
                autospec=True)
