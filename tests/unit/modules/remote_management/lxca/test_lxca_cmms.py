...
from ansible_collections.ansible.misc.plugins.modules import lxca_cmms
...
class TestMyModule():
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_cmms.execute_module', autospec=True)
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_cmms.execute_module', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_cmms.AnsibleModule', autospec=True)
    ...
    @mock.patch('ansible_collections.ansible.misc.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_cmms._cmms_by_uuid',
                autospec=True)
    @mock.patch('ansible_collections.ansible.misc.plugins.modules.lxca_cmms.AnsibleModule',
                autospec=True)
