...
from ansible_collections.ansible.misc.plugins.modules import bitbucket_pipeline_variable
...
from ansible_collections.ansible.misc.tests.unit.modules.utils import AnsibleFailJson, AnsibleExitJson, ModuleTestCase, set_module_args
